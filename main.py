...
# ============================== CONFIG ======================================
API_ID = 12345678                 # <-- apna API ID daalein
...
if __name__ == "__main__":
    if not STRING_SESSION.strip():
        print("STRING_SESSION khaali hai!")
        print("Pehle 'python generate_session.py' chalayein, output copy karein,")
        print("aur is file ke STRING_SESSION variable me paste karein.")
    else:
